...
def main():
    ...
    parser.add_argument('--reload-covid', dest='reload', action='store_true',
                    help='repeat download of covid19-data')
    ...
    file = Path.joinpath(main_dir, 'data', '01_raw_data', 'RKI_COVID19.csv')
    if not os.path.exists(file) or args.reload:
